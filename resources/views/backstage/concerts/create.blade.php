                    ...
                    <div class="col col-lg-4">
                        <div class="p-xs-y-4">
                            ...
                            <p class="text-dark-soft text-sm m-xs-b-4">Tell us who's playing! <em>(Please be
                                    Slayer!)</em></p>
                            <p class="text-dark-soft text-sm">Include the headliner in the concert name, use the
                ...
                <div class="row">
                    <div class="col col-lg-4">
                        <div class="p-xs-y-4">
                            ...
                            <p class="text-dark-soft text-sm">True metalheads really only care about the obscure
                ...
                <div class="row">
                    <div class="col col-lg-4">
                        <div class="p-xs-y-4">
                            ...
                            <p class="text-dark-soft text-sm">Where's the show? Let attendees know the venue name and
                        ...
                        <div class="card">
                            <div class="card-section">
                                ...
                                <div class="form-group {{ $errors->first('venue_address', 'has-error') }}">
                                    ...
                                    <input name="venue_address" class="form-control" value="{{ old('venue_address') }}"
                ...
                <div class="row">
                    <div class="col col-lg-4">
                        <div class="p-xs-y-4">
                            ...
                            <p class="text-dark-soft text-sm">Set your ticket price and availability, but don't forget,
