...
class EditConcertListTest extends TestCase
{
    ...
    /** @test */
    function promoters_see_a_404_when_attempting_to_view_the_edit_page_of_a_concert_that_does_not_exist()
    {
        $user = factory(User::class)->create();
    ...
    function promoters_can_edit_their_own_unpublished_concerts()
    {
        ...
        $response = $this->actingAs($user)->patch("/backstage/concerts/{$concert->id}", $this->validParams(['ticket_quantity' => '10']));
    ...
    public function title_is_required()
    {
        ...
        $response = $this->from(url("/backstage/concerts/{$concert->id}/edit"))->actingAs($user)->patch("/backstage/concerts/{$concert->id}", $this->validParams(['title' => '']));
    ...
    public function venue_is_required()
    {
        ...
        $this->assertArraySubset($this->oldAttributes(['user_id' => $user->id, 'venue' => 'Old Venue',
